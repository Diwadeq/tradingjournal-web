...
| File | Purpose |
|---|---|
| `index.html` | App shell: login screen, tab bar, modals, CDN script tags |
...
| `drive.js` | Google Drive layer — OAuth token, find/download/upload `journal.db` |
| `app.js` | The SPA: dashboard/calendar, trades, add/edit form, analytics, accounts |
